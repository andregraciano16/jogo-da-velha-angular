...
export class JogoDaVelhaService {
  ...
  /**
   * Retorna so numero do jogador a jogar
   *
   * @return boolean
   */
  ...
  /**
   * Realizar uma hogada dado as coordenadas do tabuleiro
   *
   * @param number posX
   * @param number posY
   * @return void
  ...
  /**
   *
   * Lógica que simula a jogada de um computador
   *
   * @return void
   *
   */
  ...
  /**
   * Obtem uma jogada válida para a vitória de um jogador
   *
   * @param number jogador
   * @return number[]
   */
  ...
  /**
   * Retorna se a peça X deve ser exibida para o coordenada informada
   *
   * @param number posX
   * @param number posY
   * @return boolean
